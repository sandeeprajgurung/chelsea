...
<body>
    ...
    <div class="page-content">
        ...
        <div class="container-fluid px-6 py-4">
            ...
            <div class="card my-4">
                <div class="card-body">
                    <form class="needs-validation category-form" novalidate>
                        <div class="row g-3 align-items-center py-3">
                            <div class="col-auto m-0">
                                <label for="name" class="col-form-label">New category</label>
                                <input type="text" id="name" name="name" class="form-control" required>
                                <em id="name-error" class="error help-block"></em>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary js-submit-category">Submit</button>
                    </form>
                </div>
            </div>
